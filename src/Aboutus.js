...
import {Container,RowProps,Col, Row} from 'react-bootstrap';
...
render()
{
    ...
    return(
        ...
        <Container>
            <Row>
           <Col>
           <div style={{width:"960px",padding:"50px",margin:"50px auto",height:"500px",backgroundColor:"#fff",boxSizing:"border-box"}} >
